...
import { createElement, getSvgPathFromStroke, isPointNearElement } from '../utilities/element';
    ...
    switch(action.type){
        case BOARD_ACTIONS.CHANGE_TOOL:
            ...
            case BOARD_ACTIONS.DRAW_DOWN : {
                ...
                const newElement = createElement(state.elements.length,
                    clientX,
                    clientY,
                    clientX,
                    clientY,
                ...
                return{
                    ...state,
                    toolActionType:state.ActiveToolItem === 
                    TOOL_ITEMS.TEXT ? TOOL_ACTION_TYPES.WRITTING:
